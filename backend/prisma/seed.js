...
async function main() {
    ...
    const course2 = await prisma.course.upsert({
        ...
        create: {
            ...
            learningObjectives: '1. Memahami model relasional\n2. Menulis query SQL\n3. Merancang skema database',
    ...
    await prisma.moduleFile.create({
        data: {
            ...
            fileType: client_1.ModuleFileType.PDF,
